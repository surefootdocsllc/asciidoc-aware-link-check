...
const includeProcessor = require('./asciidoc/asciidoc-include-processor');
...
function getLinks(assemblyFile, options = {}) {
  ...
  if(options.useAsciibinderStyleIncludes) {
    includeProcessor(registry, process.cwd());
...
/*
{
  ...
  "message": {
    ...
    "source_location": {
      "$$id": 1710,
      "file": "/Users/hellworld/Self/work/rhel-8-docs/enterprise/titles/configuring-and-maintaining/managing-storage-devices/assemblies/assembly_overview-of-available-storage-options.adoc",
      "dir": "/Users/helloworld/Self/work/rhel-8-docs/enterprise/titles/configuring-and-maintaining/managing-storage-devices/assemblies",
